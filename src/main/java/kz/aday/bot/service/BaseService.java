...
public abstract class BaseService<T extends Id> {
    ...
    public T save(T entity) {
        ...
        boolean isNew = !repository.existById(entityId); // Проверяем, новая ли это сущность или обновление
    ...
    public void deleteAll() {
        log.warn("Clearing all entities from the repository."); // WARN, так как это деструктивная операция
        repository.clearAll();
