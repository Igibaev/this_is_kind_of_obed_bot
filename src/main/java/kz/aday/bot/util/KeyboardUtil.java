...
public class KeyboardUtil {
  ...
  public static InlineKeyboardMarkup createInlineKeyboard(List<UserButton> userButtons) {
  ...
  public static InlineKeyboardMarkup createInlineKeyboard(
      List<Item> itemList, CallbackState state) {
    return createInlineKeyboard(itemList, Collections.emptySet(), state);
  }

  public static InlineKeyboardMarkup createInlineKeyboard(
      List<Item> itemList, Set<Item> selectedItems, CallbackState state) {
    InlineKeyboardMarkup markup = new InlineKeyboardMarkup();
    List<List<InlineKeyboardButton>> keyboard = new ArrayList<>();
