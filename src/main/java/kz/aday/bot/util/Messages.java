...
public enum Messages {
  ...
  MENU_TEMPLATE(
      "Шаблон меню:\n"
          ...
          + "\n"
          + "Дедлайн 11:00. (дедлайн можно указывать так, можно просто время указывать в формате"
          + " HH:mm)\n"
          + "\n"
  ...
  YOUR_ORDER_FOR_LUNCH("Твой заказ на обед %s: %s."),
  ...
  ORDER_IS_EMPTY_FOR_LUNCH("Заказ на обед %s не найден."),
  ...
  NOBODY_COMES_FOR_LUNCH("На обед %s никто в офис не придет."),
  WHO_COMES_TODAY("Сегодня в офис придет [%s]:\n%s"),
  WHO_COMES_TOMORROW("Завтра в офис придет [%s]:\n%s"),
  WHO_COMES_FOR_LUNCH("На обед %s в офис придет [%s]:\n%s"),
  ...
  FEEDBACK_FORM(
      "Это форма обратной связи. Приложите фотографии, аудио, видео или просто текстом опишите,"
          + " ваши пожелания как сделать чат бот лучше и удобнее."),
  ...
  DATA_EXPORT_EMPTY("Директория с данными пуста или не найдена. Экспортировать нечего."),
  DATA_EXPORT_ERROR("Произошла ошибка при подготовке архива с данными."),
  DATA_EXPORT_TOO_LARGE("Архив данных превышает лимит Telegram в 50MB и не может быть отправлен."),
