...
class GetOrderTodayCallbackHandlerTest {
  ...
  private GetOrderTodayCallbackHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new GetOrderTodayCallbackHandler();
  }

  @Test
  void canHandle_returnsTrue_whenCallbackStateIsGetOrderToday() {
    CallbackQuery callback = callbackQuery(CallbackState.GET_ORDER_TODAY.name());
