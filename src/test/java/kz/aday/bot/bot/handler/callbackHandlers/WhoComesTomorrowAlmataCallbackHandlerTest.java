...
class WhoComesTomorrowAlmataCallbackHandlerTest {
  ...
  private WhoComesTomorrowAlmataCallbackHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new WhoComesTomorrowAlmataCallbackHandler();
  }

  @Test
  void canHandle_returnsTrue_whenCallbackStateIsWhoComesTomorrowAlmata() {
    CallbackQuery callback = callbackQuery(CallbackState.WHO_COMES_TOMORROW_ALMATA.name());
