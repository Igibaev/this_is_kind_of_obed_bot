...
class CancelCommandHandlerTest {
  ...
  private CancelCommandHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new CancelCommandHandler();
  }

  @Test
  void canHandle_returnsTrue_whenCommandIsCancel() {
    assertTrue(handler.canHandle("/cancel"));
  }

  @Test
  void handle_resetsStateAndSendsNavigationMenu_whenUserReady() throws Exception {
    ...
    verify(messageSender).sendMessage(any(), eq(sender), eq(true));
  }
