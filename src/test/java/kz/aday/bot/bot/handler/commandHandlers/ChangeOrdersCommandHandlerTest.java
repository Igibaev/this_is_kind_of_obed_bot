...
class ChangeOrdersCommandHandlerTest {
  ...
  private ChangeOrdersCommandHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new ChangeOrdersCommandHandler();
  }

  @Test
  void canHandle_returnsTrue_whenCommandIsChangeOrders() {
    assertTrue(handler.canHandle("/changeorders"));
  }
