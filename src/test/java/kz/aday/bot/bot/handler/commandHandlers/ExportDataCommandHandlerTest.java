...
class ExportDataCommandHandlerTest {
  ...
  private ExportDataCommandHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new ExportDataCommandHandler();
  }

  @Test
  void canHandle_returnsTrue_whenCommandStartsWithExportData() {
    assertTrue(handler.canHandle("/exportdata"));
  }
