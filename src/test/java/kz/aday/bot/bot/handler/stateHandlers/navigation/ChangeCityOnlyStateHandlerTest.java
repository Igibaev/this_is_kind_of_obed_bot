...
class ChangeCityOnlyStateHandlerTest {
  ...
  private ChangeCityOnlyStateHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new ChangeCityOnlyStateHandler();
  }
  ...
  @Test
  void canHandle_givenChangeCityButtonText_whenCalled_thenReturnsTrue() {
    assertTrue(handler.canHandle(State.CHANGE_CITY_ONLY.getDisplayName()));
  }

  @Test
  void handle_promptsForCityWithoutAskingForName_whenCalled() throws Exception {
    // given
    User user = readyUser();
