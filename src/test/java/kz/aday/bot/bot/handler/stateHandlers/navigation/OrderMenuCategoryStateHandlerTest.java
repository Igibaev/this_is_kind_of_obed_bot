...
class OrderMenuCategoryStateHandlerTest {
  ...
  private OrderMenuCategoryStateHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new OrderMenuCategoryStateHandler();
  }
  ...
  @Test
  void canHandle_givenOrderMenuCategoryButtonText_whenCalled_thenReturnsTrue() {
    assertTrue(handler.canHandle(State.MENU_CATEGORY_ORDER.getDisplayName()));
  }
  ...
  void handle_sendsCategoryPromptAndActionButtons_whenUserExists() throws Exception {
    ...
    assertTrue(actualMessage.getText().equals(Messages.CATEGORY_PROMPT.getText()));
    assertTrue(actualMessage.getReplyMarkup() != null);
  }
