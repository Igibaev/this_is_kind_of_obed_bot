...
class StatisticsMenuStateHandlerTest {
  ...
  private StatisticsMenuStateHandler handler;
  ...
  void setUp() throws Exception {
    ...
    handler = new StatisticsMenuStateHandler();
  }

  @Test
  void canHandle_returnsTrue_whenStateIsStatisticsMenu() {
    assertTrue(handler.canHandle(State.STATISTICS_MENU.getDisplayName()));
  }

  @Test
  void handle_sendsStatisticsCard_whenUserExists() throws Exception {
    User user = readyUser();
